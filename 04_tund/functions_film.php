...
function readAllFilms(){
	...
	$filmInfoHTML = null;
	while ($stmt->fetch()){
		$filmDurationH = $filmDuration;
		if(round($filmDuration / 60) > 1 and $filmDuration % 60 > 1){
			$filmDurationH = round($filmDuration / 60) ." tundi ja " .$filmDuration % 60 ." minutit.";
		} elseif (round($filmDuration / 60) > 1 and $filmDuration % 60 == 1){
			$filmDurationH = round($filmDuration / 60) ." tundi ja " .$filmDuration % 60 ." minut.";
		} elseif (round($filmDuration / 60) > 0 and $filmDuration % 60 > 1){
			$filmDurationH = round($filmDuration / 60) ." tund ja " .$filmDuration % 60 ." minutit.";
		} elseif (round($filmDuration / 60) > 0 and $filmDirector % 60 == 1) {
			$filmDurationH = round($filmDuration / 60) ." tund ja " .$filmDuration % 60 ." minut.";
		} else {
